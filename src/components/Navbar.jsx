...
import orighinn from '../assets/logo-bg-white.png'
    ...
    >
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative flex h-20 items-center justify-center">
          <Link to="/" className="absolute left-4 md:left-8 flex items-center">
            <div className="flex items-center gap-2">
              {/* <img src={logoo} alt="Origihn logo" className="h-12 w-auto" /> */}
              <img src={orighinn} alt="Origihn wordmark" className="h-12 w-auto hidden sm:block" />
            </div>
          </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-2 bg-white bg-opacity-95 backdrop-blur-sm border-t border-white/20">
            ...
            <Link to="/products" className={linkClass('/products', true)}>Shop</Link>
            ...
            <Link to="/contact" className={linkClass('/contact', true)}>Contact Us</Link>
          </div>
        )}
      </div>
    </nav>
